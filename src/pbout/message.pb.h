...
class Header : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:msg.Header) */ {
 public:
  Header();
  virtual ~Header();
...
class Body : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:msg.Body) */ {
 public:
  Body();
  virtual ~Body();
...
class Msg : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:msg.Msg) */ {
 public:
  Msg();
  virtual ~Msg();
...
inline ::msg::Header* Msg::release_header() {
  // @@protoc_insertion_point(field_release:msg.Msg.header)
  clear_has_header();
...
inline ::msg::Body* Msg::release_body() {
  // @@protoc_insertion_point(field_release:msg.Msg.body)
  clear_has_body();
  ::msg::Body* temp = body_;
  body_ = NULL;
  return temp;
